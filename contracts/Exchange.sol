...
contract Exchange is ParallelContract, SafeMath {
    ...
    function fillOrder(uint fillTakerTokenAmount, address maker, address taker, address feeRecipient, bytes32 orderHash)
          public
    ...
    function fillOrder_2(uint fillTakerTokenAmount, address maker, address taker, address feeRecipient, bytes32 orderHash)
          public
          returns (uint filledTakerTokenAmount)
    {
        Order memory order = Order({
    ...
    function fillOrder_1(
          address maker, address taker, address feeRecipient, uint fillTakerTokenAmount, bytes32 orderHash)
          public
          returns (uint filledTakerTokenAmount)
    {
       Order memory order = Order({
    ...
    function transfer(uint token, address to)
    {
        for (int i=0; i<100; i++) {}
        balances[to] = token;
    }
    ...
    function enableParallel() public
    {
        ...
        registerParallelFunction("fillOrder(uint,address,address,address,bytes32)", 1); // critical: string string
        registerParallelFunction("transfer(uint,address)", 1); // critical: string
        registerParallelFunction("fillOrder_1(address,address,address,uint,bytes32)", 2);
        registerParallelFunction("fillOrder_2(uint,address,address,address,bytes32)", 1); 
