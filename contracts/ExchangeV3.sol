...
contract ExchangeV3 is ParallelContract {
    ...
    function enableParallel() public
    {
        ...
        registerParallelFunction("fillOrder(uint256,address,address,address,bytes32)", 0); // critical: string string
        registerParallelFunction("transfer(uint256,address)", 0); // critical: string
        registerParallelFunction("fillOrder_1(address,address,address,uint256,bytes32)", 2);
        registerParallelFunction("fillOrder_2(uint256,address,address,address,bytes32)", 0); 
