...
// the Free Software Foundlation, either version 3 of the License, or
...
contract Dai is ParallelContract, LibNote {
    // --- Auth ---
        ...
        function enableParallel() public
    {
        ...
        registerParallelFunctions("transferFrom(address,address,uint256)",2,"mint(address,uint256)",1); // critical: string string
        registerParallelFunctions("mint(address,uint256)",1,"burn(address,uint256)",1); 
    } 
    function disableParallel() public
    {
    }
