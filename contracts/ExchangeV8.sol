...
/// @author Amir Bandeali - <amir@0xProject.com>, Will Warren - <will@0xProject.com>
contract ExchangeV8 is ParallelContract, SafeMath {
        ...
        returns (uint)
    {
        ...
        for (uint i = 0; i < orderAddresses.length; i++) {
            ...
            uint filled = fillOrder(
                ...
                r[i],
                s[i]);
            filledTakerTokenAmount = safeAdd(filledTakerTokenAmount, filled);
    ...
    */
	...
	registerParallelFunctions("fillOrKillOrder(bytes32,address,address,address[5],uint256[6],uint256,uint8,bytes32,bytes32)",3,"cancelOrder(bytes32,address,address,address[5],uint256[6],uint256)",3);
	registerParallelFunctions("fillOrKillOrder(bytes32,address,address,address[5],uint256[6],uint256,uint8,bytes32,bytes32)",3,"fillOrder(bytes32,address,address,address[5],uint256[6],uint256,bool,uint8,bytes32,bytes32)",3);
    } 
   function disableParallel() public
   {
   }
